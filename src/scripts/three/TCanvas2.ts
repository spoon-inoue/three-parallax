...
export class TCanvas2 extends TCanvasBase {
	private assets: Assets = {
		...
		house3: { path: publicPath('/assets/02/house3.png'), encoding: true },
		...
		forest2: { path: publicPath('/assets/02/forest.png'), encoding: true },
		grass2: { path: publicPath('/assets/02/grass_02.png'), encoding: true },
		man: { path: publicPath('/assets/02/man.png'), encoding: true },
		trees: { path: publicPath('/assets/02/trees.png'), encoding: true },
		// movie
		smoke: { path: publicPath('/assets/smoke.webm') },
		moveButterflies: { path: publicPath('/assets/butterflies.webm'), encoding: true },
		moveTree: { path: publicPath('/assets/02/tree.webm'), encoding: true }
	}
	...
	private createModel = () => {
		...
		const moveTree = createVideoMesh('moveTree', 0.6)
		const moveTree2 = createVideoMesh('moveTree', 0.6)
		const moveTree3 = createVideoMesh('moveTree', 0.6)
		const moveTree4 = createVideoMesh('moveTree', 0.6)
		const moveTree5 = createVideoMesh('moveTree', 0.6)
		const moveTree6 = createVideoMesh('moveTree', 0.6)
		const moveTree7 = createVideoMesh('moveTree', 0.6)
		const moveTree8 = createVideoMesh('moveTree', 0.6)
		moveTree.position.set(-0.8, 0.3, 0.1)
		moveTree2.position.set(-0.8, 0.3, 0.1)
		moveTree3.position.set(-0.8, 0.3, 0.1)
		moveTree4.position.set(-0.8, 0.3, 0.1)
		moveTree5.position.set(-0.8, 0.3, 0.1)
		moveTree6.position.set(-0.8, 0.3, 0.1)
		moveTree7.position.set(-0.8, 0.3, 0.1)
		moveTree8.position.set(-0.8, 0.3, 0.1)
		trees.add(moveTree,moveTree2,moveTree3,moveTree4,moveTree5,moveTree6,moveTree7,moveTree8)
